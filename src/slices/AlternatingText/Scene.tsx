...
export default function Scene({flavors}:Props) {
    ...
    const scrollTl = gsap.timeline({
      scrollTrigger: {
        ...
        onUpdate: (self) => {
          ...
          const index = Math.floor(self.progress * (flavors.length - 1));
  ...
  return (
    ...
    >
      {/* Floating Can with dynamic flavor */}
      <FloatingCan flavor={currentFlavor} />
